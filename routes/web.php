...
Route::group(['middleware' => ['auth']] , function () {
 ...
 //    });
    ...
    Route::get('/dahboard_data', [App\Http\Controllers\Controller::class, 'index11']);
    Route::get('/', [App\Http\Controllers\Controller::class, 'index'])->name('home');
    Route::get('/home', [App\Http\Controllers\Controller::class, 'index'])->name('home');

    Route::post('/assign_rider', [App\Http\Controllers\Controller::class, 'assign_rider'])->name('assign_rider');
    Route::post('/order_details', [App\Http\Controllers\Controller::class, 'order_details'])->name('order_details');

    // customer routes //
    Route::get('/customer', [App\Http\Controllers\CustomerController::class, 'get_customer']);
    Route::post('/add_customer', [App\Http\Controllers\CustomerController::class, 'add_customer']);
    Route::get('/get_customer/{id}', [App\Http\Controllers\CustomerController::class,'get_customer_by_id']);
    Route::post('/edit_customer', [App\Http\Controllers\CustomerController::class, 'edit_customer']);
    Route::post('/update_customer_wallet', [App\Http\Controllers\CustomerController::class, 'update_customer_wallet']);
    Route::get('/wallet', [App\Http\Controllers\CustomerController::class, 'wallet']);
    ...
    // item routes//
    Route::post('/add_item', [App\Http\Controllers\ItemController::class, 'add_item']);
    Route::get('/item', [App\Http\Controllers\ItemController::class, 'get_item']);
    Route::get('/get_item/{id}', [App\Http\Controllers\ItemController::class,'get_item_by_id']);
    Route::post('/edit_item', [App\Http\Controllers\ItemController::class, 'edit_item']);

    Route::post('/update_all_item', [App\Http\Controllers\ItemController::class, 'update_all_item']);
    // item routes//


    // users routes//
    Route::post('/add_user', [App\Http\Controllers\UserController::class, 'add_user']);
    Route::get('/user', [App\Http\Controllers\UserController::class, 'get_user']);
    Route::get('/get_user/{id}', [App\Http\Controllers\UserController::class,'get_user_by_id']);
    Route::post('/edit_user', [App\Http\Controllers\UserController::class, 'edit_user']);
    // users routes//


    // orders routes //
    Route::get('/order', [App\Http\Controllers\OrderController::class, 'get_order']);
    Route::post('/add_user', [App\Http\Controllers\UserController::class, 'add_user']);
    Route::get('/get_user/{id}', [App\Http\Controllers\UserController::class,'get_user_by_id']);
    Route::post('/edit_user', [App\Http\Controllers\UserController::class, 'edit_user']);
    Route::get('/order_detail_items/{id}', [App\Http\Controllers\OrderController::class, 'order_detail_items']);

    //Route::get('/get_order_detail_iitems', [App\Http\Controllers\OrderController::class, 'get_order_detail_iitems']);
    
    // orders routes //


    // rider routes //
    Route::get('/rider', [App\Http\Controllers\UserController::class, 'get_rider']);
    Route::post('/add_rider', [App\Http\Controllers\UserController::class, 'add_rider']);
    Route::get('/get_rider/{id}', [App\Http\Controllers\UserController::class,'get_rider_by_id']);
    Route::post('/edit_rider', [App\Http\Controllers\UserController::class, 'edit_rider']);
    Route::get('/verify_number/{num}', [App\Http\Controllers\UserController::class,'verify_number']);
    // rider routes
    ...
    Route::post('/save_setting', [App\Http\Controllers\SettingController::class, 'save_setting']);
    // settings routes
    ...
    //Route::group(['middleware' => ['auth']], function() {
        ...
        Route::get('/resetRole', [App\Http\Controllers\RoleController::class, 'faheem']);
...
Route::get('/table-editable', function () {
    return view('html-pages/table-editable');
});
