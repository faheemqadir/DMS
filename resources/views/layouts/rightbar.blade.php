<div class="rightbar">
                                            ...
                                            <div class="userbox">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="media dropdown-item">
                                                        ...
                                                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><img src="{{ asset('assets/images/svg-icon/logout.svg')}}" class="img-fluid" alt="logout">
                                                            Logout
                                                        </a>
                  ...
                  <ul class="horizontal-menu d-none">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a href="{{url('/widgets')}}"><img src="{{ asset('assets/images/svg-icon/widgets.svg')}}" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-success pull-right">New</span></a>                                        
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
    ...
    <div class="footerbar">
        <footer class="footer">
            <p class="mb-0">© 2021 DMS - All Rights Reserved.</p>
        </footer>
    </div>
    <!-- End Footerbar -->
</div>